...
public class Bug1127804Test {
    ...
    private void performTest(String module) throws Exception {
    ...
    @Test
    public void testArtifactClassifier() throws Exception {
    ...
    @Test
    public void testPomConversion() throws Exception {
